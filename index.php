        ...
        <div class="col-md-5 col-lg-4">
            <div class="card border-0 shadow-sm h-100" style="border-radius: 20px;">
                <div class="card-body text-center p-4">
                    ...
                    <p class="card-text text-muted mb-4 small">Kelola data mahasiswa, tambah, edit, atau hapus data dengan mudah.</p>
                    <a href="mahasiswa/read.php" class="btn btn-primary w-100 py-2 fw-semibold" style="border-radius: 10px;">Buka Data Mahasiswa</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5 col-lg-4">
            <div class="card border-0 shadow-sm h-100" style="border-radius: 20px;">
                <div class="card-body text-center p-4">
                    ...
                    <p class="card-text text-muted mb-4 small">Lihat dan atur daftar program studi yang tersedia di fakultas.</p>
                    <a href="programstudi/read.php" class="btn btn-dark w-100 py-2 fw-semibold" style="border-radius: 10px;">Buka Program Studi</a>
                </div>
            </div>
        </div>
    </div>
